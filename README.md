...
![mc_model_solver_ui](docs/mc_model_gen_bipyramid.png)
...
## CEM
- [cem_obj_geom_diff](cem_obj_geom_diff.py) Compares two `.obj` files per-object (bbox/centroid/extents, optional vertex-set equivalence with translation/rotation detection).
